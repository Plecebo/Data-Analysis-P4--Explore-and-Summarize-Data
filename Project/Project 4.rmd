...
What about over time donations?
...
Oops that didn't give at all what I expected. I wonder if the receipt needs to be converted into a date? 
...
Much better, but too much information, let's just look at since March of 2015.
...
Man the Republican contributions are much more competitive, the dems are dominated by Clinton. 
...
Let's take a look at how the debates impacted donations. 
